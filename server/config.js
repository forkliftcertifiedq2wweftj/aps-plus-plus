module.exports = {
    ...
    FOOD_TYPES: [
        [1000, [
            [1024, 'egg'], [256, 'square'], [64, 'triangle'], [16, 'pentagon'], [4, 'betaPentagon'], [1, 'alphaPentagon'], [0.5, 'hexagon'], [0.25, 's7']
        ]],
         [200, [
            [1024, 'cs'], [256, 'ct'], [64, 'cp']
        ]],
        [22.222222, [
            [3125, 'gem'], [625, 'shinySquare'], [125, 'shinyTriangle'], [25, 'shinyPentagon'], [5, 'shinyBetaPentagon'], [1, 'shinyAlphaPentagon'], [0.5, 'sh']
        ]],
        [1.111111, [
            [6836, 'jewel'], [1296, 'legendarySquare'], [216, 'legendaryTriangle'], [36, 'legendaryPentagon'], [6, 'legendaryBetaPentagon'], [1, 'legendaryAlphaPentagon'], [0.5, 'lh']
        ]],
        [0.370373, [
            /*[16807, 'egg'], */[2401, 'shadowSquare'], [343, 'shadowTriangle'], [49, 'shadowPentagon'], [7, 'shadowBetaPentagon'], [1, 'shadowAlphaPentagon'], [0.5, 'shh']
        ]],
        [0.019841, [
            /*[65536, 'egg'], */[8192, 'rainbowSquare'], [1024, 'rainbowTriangle'], [64, 'rainbowPentagon'], [8, 'rainbowBetaPentagon'], [1, 'rainbowAlphaPentagon'], [0.6, 'rh']
        ]],
        [0.007309, [
            [59549, 'egg'], [6561, 'transSquare'], [729, 'transTriangle'], [81, 'transPentagon'], [9, 'transBetaPentagon'], [1, 'transAlphaPentagon'], [0.7, 'th']
        ]],
        [0.000322, [
    ...
    FOOD_TYPES_NEST: [
        [1, [
            [64, 'pentagon'], [ 16, 'betaPentagon'], [ 4, 'alphaPentagon'], [ 2, 'hexagon'], [ 1.5, 'heptagon'], [ 1, 'betahexagon'], [ 0.5, 'alphahexagon']
        ]]
    ],
